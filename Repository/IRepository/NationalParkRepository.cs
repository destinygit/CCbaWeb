...
namespace CCbaWeb.Repository.IRepository
{
    ...
    {
        //Need this AppDbContext object to access or connect to the Database
        private readonly ApplicationDbContext _db;

        //Need this constructor to get it using dependency injections
        public NationalParkRepository(ApplicationDbContext db)
        {
            //able to access the applicationdbcontext
            _db = db;
        }
